...
Also see the docs on [including images in content]({{ site.baseurl }}/docs/editing/images.html) and [adding them to your project]({{ site.baseurl }}/docs/images/adding-image-files.html).
