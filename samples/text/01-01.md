...
Most books comprise pages and pages of running text. A good theme makes them lovely to look at and easy to read. The heart of a theme is how it handles both plain text and special forms like letters. There is a [letter towards the end of this chapter](#letter){:.cross-reference}.
