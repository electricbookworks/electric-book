...
CALL bundle exec jekyll serve --config="_config.yml,_config.web.yml,%config%" --baseurl="/%baseurl%"
:: And we're done here.
GOTO end
...
:: ...and run Jekyll to build new HTML
CALL bundle exec jekyll serve --config="_config.yml,_config.web.yml,%config%" --baseurl=""
:: And we're done here.
GOTO end
:end